  ...
  grunt.initConfig({
    ...
    nodewebkit: {
      options: {
        ...
        mac_icns: './images/freedomflix.icns', // Path to the Mac icon file
        ...
        files: [
          {
            ...
            dest: 'build/releases/FreedomFlix/win/FreedomFlix/ffmpegsumo.dll',
            flatten: true
          },
          {
            src: 'libraries/win/ffmpegsumo.dll',
          ...
          },
          {
            ...
            dest: 'build/releases/FreedomFlix/mac/FreedomFlix.app/Contents/Frameworks/node-webkit Framework.framework/Libraries/ffmpegsumo.so',
            flatten: true
          },
          {
            src: 'libraries/mac/ffmpegsumo.so',
          ...
          },
          {
            ...
            dest: 'build/releases/FreedomFlix/linux64/FreedomFlix/libffmpegsumo.so',
            flatten: true
          },
          {
            src: 'libraries/linux64/libffmpegsumo.so',
