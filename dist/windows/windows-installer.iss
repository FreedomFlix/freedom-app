; Installer Variables
#define AppName "FreedomFlix"
#define AppVersion "Beta 2.5"
#define AppPublisher "FreedomFlix Team"
#define AppURL "https://github.com/freedomflix/freedom-app"
...
; Don't ask for a install folder (it goes into \Users\Username\AppData\Roaming\FreedomFlix\, which doesn't require admin privileges)
UsePreviousAppDir=no
DefaultDirName={userappdata}\FreedomFlix
DisableDirPage=yes
...
; Final Installer
OutputBaseFilename=Install FreedomFlix
SetupIconFile=..\..\images\freedomflix.ico
OutputDir=.\
...
Name: "{app}\{#AppName}"; WorkingDir: "{app}"; Filename: "{app}\node-webkit\nw.exe"; Parameters:"""{app}\app"""; IconFilename: "{app}\app\images\freedomflix.ico"; Flags: runminimized preventpinning
; Another in the group (this one can be featured)
Name: "{group}\{#AppName}"; WorkingDir: "{app}"; Filename: "{app}\node-webkit\nw.exe"; Parameters:"""{app}\app"""; IconFilename: "{app}\app\images\freedomflix.ico"; Flags: runminimized
