...
del "%CD%\FreedomFlix.app\Contents\Resources\nw.icns"
copy "%CD%\freedomflix.icns" "%CD%\FreedomFlix.app\Contents\Resources\nw.icns"

:: And the custom .plist
del "%CD%\FreedomFlix.app\Contents\Info.plist"
copy "%CD%\Info.plist" "%CD%\FreedomFlix.app\Contents\Info.plist"

:: Zip the file (Requires 7zip)
del "FreedomFlix.zip"
"%ProgramFiles%\7-Zip\7z.exe" a -tzip -mx9 "FreedomFlix.zip" "FreedomFlix.app"