...
App.View.Sidebar = Backbone.View.extend({
    ...
    play: function (evt) {
        ...
        $('.freedom-load').addClass('withProgressBar').addClass('cancellable').find('.progress').css('width', 0.0+'%');
        $('.freedom-load .progressinfo').text( i18n.__('connecting') );
        ...
        playTorrent(file, subsFiles, movieModel,
            ...
            function(percent){
                ...
                var $progress = $('.freedom-load').find('.progress');
                ...
                $('.freedom-load').find('.progress').css('width', percent+'%');
                ...
                $('.freedom-load .progressinfo').text( i18n.__(bufferStatus) );
            }
        );
